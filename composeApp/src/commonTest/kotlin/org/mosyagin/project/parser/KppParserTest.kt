...
class KppParserTest {
    ...
    fun testKppParsingAndLinking() {
        ...
        sceneRepo.addFakeScene(GetScenesByProject(101, projectId, 1L, "1", "КУХНЯ", 1, "ДЕНЬ", null, 0, 0L, "Текст", "hash"))
        sceneRepo.addFakeScene(GetScenesByProject(102, projectId, 1L, "2", "ДВОР", 0, "НОЧЬ", null, 0, 0L, "Текст", "hash"))
